...
<nav class="mb-1 navbar navbar-expand-lg fixed-top black white-text">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
    ...
    <?php
    if (empty($_SESSION['customer_name']) && empty($_SESSION['customer_password'])) {
    ...
    <?php
      ...
      <img src="/e-commerce_with_purephp/assets/images/userprofiles/empty-user.png" class="rounded-circle float-right" alt="Invalid" width="30px" height="30px" style="cursor: pointer;">
            ...
            <form method="POST"  action="/e-commerce_with_purephp/includes/handleforms/login.php">
              ...
              <div class="modal-body mb-1">
                ...
                <div class="md-form form-sm mb-4">
                  ...
                  <input type="password" id="modalLRInput11" class="form-control form-control-sm validate" autocomplete="on">
            ...
            <form method="POST" action="/e-commerce_with_purephp/includes/handleforms/register.php">
              <div class="modal-body">
                ...
                <div class="md-form form-sm mb-5">
                  ...
                  <input type="date" id="dob" class="form-control form-control-sm validate" name="dob">
